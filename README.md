...
Once the `conda-forge` channel has been enabled, `wiutils` can be installed with:

```
conda install wiutils
```

It is possible to list all of the versions of `wiutils` available on your platform with:
